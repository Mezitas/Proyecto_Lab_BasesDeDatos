...
{
    partial class View_CrearUsuario
    {
        /// <summary> 
        ...
        {
            lbl_CrearUsuario_Usuario = new Label();
            txt_CrearUsuario_Usuario = new TextBox();
            lbl_CrearUsuario_Contrasenia = new Label();
            txt_CrearUsuario_Contrasenia = new TextBox();
            lbl_CrearUsuario_Confirmar = new Label();
            txt_CrearUsuario_Confirmar = new TextBox();
            lbl_CrearUsuario_Nombre = new Label();
            txt_CrearUsuario_Nombre = new TextBox();
            lbl_CrearUsuario_Telefono = new Label();
            txt_CrearUsuario_Telefono = new TextBox();
            ...
            lbl_CrearUsuario_Usuario.Text = "Usuario";
            // 
            ...
            lbl_CrearUsuario_Contrasenia.Text = "Contraseña";
            // 
            ...
            txt_CrearUsuario_Contrasenia.TabIndex = 3;
            // 
            ...
            lbl_CrearUsuario_Confirmar.Text = "Confirmar Contraseña";
            // 
            ...
            txt_CrearUsuario_Confirmar.TabIndex = 5;
            // 
            ...
            lbl_CrearUsuario_Nombre.Text = "Nombre Completo";
            // 
            ...
            lbl_CrearUsuario_Telefono.Text = "Teléfono";
            // 
            ...
            Controls.Add(txt_CrearUsuario_Contrasenia);
            Controls.Add(lbl_CrearUsuario_Confirmar);
            Controls.Add(txt_CrearUsuario_Confirmar);
            Controls.Add(lbl_CrearUsuario_Nombre);
            Controls.Add(txt_CrearUsuario_Nombre);
            Controls.Add(lbl_CrearUsuario_Telefono);
            Controls.Add(txt_CrearUsuario_Telefono);
            Controls.Add(lbl_CrearUsuario_Rol);
            Controls.Add(cb_CrearUsuario_Rol);
            Controls.Add(btn_CrearUsuario);
            Name = "View_CrearUsuario";
        ...
        #endregion
        private Label lbl_CrearUsuario_Usuario;
        private TextBox txt_CrearUsuario_Usuario;
        private Label lbl_CrearUsuario_Contrasenia;
        private TextBox txt_CrearUsuario_Contrasenia;
        private Label lbl_CrearUsuario_Confirmar;
        private TextBox txt_CrearUsuario_Confirmar;
        private Label lbl_CrearUsuario_Nombre;
        private TextBox txt_CrearUsuario_Nombre;
        private Label lbl_CrearUsuario_Telefono;
        private TextBox txt_CrearUsuario_Telefono;
